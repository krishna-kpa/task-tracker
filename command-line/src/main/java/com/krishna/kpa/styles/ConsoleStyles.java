package com.krishna.kpa.styles;

/**
 * Constant - this class contains all the constants that are related to console styles
 *
...
public class ConsoleStyles {
    ...
    public static final String YELLOW_BG_BRIGHT = "\033[103m";
    public static final String BLUE_BG_BRIGHT = "\033[104m";
    public static final String PURPLE_BG_BRIGHT = "\033[105m";
